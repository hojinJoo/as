...
class AudioSlot(nn.Module) :
    def __init__(self,
        ...
        self.slot_attention = SlotAttention(num_slots=num_slots,num_iterations=num_iterations,num_attn_heads=num_attn_heads,slot_dim=slot_dim,mlp_hid_dim=mlp_hid_dim,eps=eps,hid_dim=hid_dim)
